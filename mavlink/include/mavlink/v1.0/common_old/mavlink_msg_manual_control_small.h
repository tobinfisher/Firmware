...
#define MAVLINK_MSG_ID_MANUAL_CONTROL_SMALL 240

typedef struct __mavlink_manual_control_small_t
{
...
} mavlink_manual_control_small_t;

#define MAVLINK_MSG_ID_MANUAL_CONTROL_SMALL_LEN 11
#define MAVLINK_MSG_ID_240_LEN 11



#define MAVLINK_MESSAGE_INFO_MANUAL_CONTROL_SMALL { \
	"MANUAL_CONTROL", \
	6, \
 ...
 */
static inline uint16_t mavlink_msg_manual_control_small_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t target, int16_t x, int16_t y, int16_t z, int16_t r, uint16_t buttons)
{
...
#else
	mavlink_manual_control_small_t packet;
	packet.x = x;
	packet.y = y;
	packet.z = z;
	packet.r = r;
	...
	msg->msgid = MAVLINK_MSG_ID_MANUAL_CONTROL_SMALL;
 ...
 */
static inline uint8_t mavlink_msg_manual_control_small_get_target(const mavlink_message_t* msg)
{
 ...
 */
static inline int16_t mavlink_msg_manual_control_small_get_x(const mavlink_message_t* msg)
{
 ...
 */
static inline int16_t mavlink_msg_manual_control_small_get_y(const mavlink_message_t* msg)
{
 ...
 */
static inline int16_t mavlink_msg_manual_control_small_get_z(const mavlink_message_t* msg)
{
 ...
 */
static inline int16_t mavlink_msg_manual_control_small_get_r(const mavlink_message_t* msg)
{
 ...
 */
static inline uint16_t mavlink_msg_manual_control_small_get_buttons(const mavlink_message_t* msg)
{
 ...
 */
static inline void mavlink_msg_manual_control_small_decode(const mavlink_message_t* msg, mavlink_manual_control_small_t* manual_control)
{
#if MAVLINK_NEED_BYTE_SWAP
	manual_control->x = mavlink_msg_manual_control_small_get_x(msg);
	manual_control->y = mavlink_msg_manual_control_small_get_y(msg);
	manual_control->z = mavlink_msg_manual_control_small_get_z(msg);
	manual_control->r = mavlink_msg_manual_control_small_get_r(msg);
	manual_control->buttons = mavlink_msg_manual_control_small_get_buttons(msg);
	manual_control->target = mavlink_msg_manual_control_small_get_target(msg);
#else
